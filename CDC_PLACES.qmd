...
cdc_places <- CDCPLACES::get_places(
    geography = "census",
    measure = c("ISOLATION"), # "LACKTRPT", "EMOTIONSPT"), // Removing lack of transport and emotional support variables.
    age_adjust = TRUE
) |>
    clean_names() |>
    select(stateabbr, locationname, data_value, starts_with("totalpopulation")) # Consider pulling geolocation variable if mapping
