...
pacman::p_load(tidyverse, janitor, httr, jsonlite, skimr, RSocrata, CDCPLACES, readr)
```
...
Get public transit data [@pan2023].

```{r}
#| label: get-transit

X38605_0003_Data <- read_table("data/ICPSR_38605/DS0003/38605-0003-Data.tsv")
